...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <h2>Admin Menu</h2>
        <ul>
            <li><a href="admin.php"><i class="fas fa-tachometer-alt"></i><span class="menu-text">Dashboard</span></a></li> <!-- Dashboard link -->
            ...
            <li><a href="#"><i class="fas fa-tags"></i><span class="menu-text">Category List</span></a></li> <!-- New Category List link -->
