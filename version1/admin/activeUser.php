...
// Get the user ID to active, ensuring it's treated as a string
...
if (!empty($user_id)) {
    // Prepare the SQL to deactivate the user (assuming 'Active' is the status for deactivated users)
    ...
    if ($stm->execute([$user_id])) {
        ...
        // If the active fails, set an error message
